...
Template Post Type: hotels, page, post
*/
?>
<?php get_header(); ?>
	...
	<section class="breadrcumb-section">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li><a class="transition" href="<?php echo get_site_url(); ?>/hotel-destination/<?php echo strtolower(get_post_meta( get_the_ID(), 'country', true ));?>/"><?php echo get_post_meta( get_the_ID(), 'country', true );?></a></li>				
				<li><?php the_title(); ?></li>
			</ul>
		</div>
	</section>
				...
				<div class="of-hid">
					<div class="left">
						<div class="inquire-single">
							<h4>Inquire Now:</h4>
							<br>
							<div class="hotelSingleFormHolder" data="<?php the_title(); ?>">
								<?php
									echo do_shortcode(
						...
						<div class="of-hid">
							...
							<br>
							<ul class="faqs">
								<li data="tour-faqs" class="active">Hotels</li>
							</ul>
					...
					<div class="right">
						...
						<div class="other-tour-destinations">
							<?php get_other_hotels(get_post_meta( get_the_ID(), 'country', true )); ?>
						</div>
						<br>
						<h5>Promotions :</h5>
